...
from pages.cards import cards_tab
from pages.social_cards import social_cards_tab
from pages.tab_cards import tab_cards_tab
from pages.basic_boxes import basic_boxes_tab
from pages.value_boxes import value_boxes_tab

from example_plots import plot_scatter
from pages.tab_cards import text_1, text_2, text_3
...
right_ui = dac.NavbarDropdown(
	badge_label = "!",
    badge_color= "danger",
    src = "https://twitter.com/tmts_media",
	header_text="2 Items",
    children= [
...
sidebar = dac.Sidebar(
	dac.SidebarMenu(
		[
			dac.SidebarHeader(children="Company In The Rabbit Hole"),
			...
			dac.SidebarHeader(children="Educational"),
			...
			dac.SidebarHeader(children="About Us"),
			dac.SidebarMenuItem(label='Galleries', icon='cubes', children=subitems),
		]
	),
    title='TMTS Peek Into The Future',
	skin="dark",
    color="primary",
	brand_color="primary",
    url="https://twitter.com/tmts_media",
