...
class CompanyFinancials(metaclass=abc.ABCMeta):
    ...
    def _parse_to_timescaled_dict(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
        ...
        if timescale == 'QoQ':            
            ...
            df_data.drop('date', axis = 1)
            df_data.groupby('Year').sum().reset_index()
    ...
    def get_revenue(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
    ...
    def get_gross_profit(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
    ...
    def get_income_ops(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
    ...
    def get_net_income(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
    ...
    def get_adj_ebitda(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
    ...
    @abc.abstractmethod
    def get_fcf(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
    ...
    def get_gross_profit_margin(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
    ...
    def get_income_ops_margin(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
    ...
    def get_net_income_margin(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
    ...
    def get_adj_ebitda_margin(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
    ...
    def get_current_ratio(self, collection: str, keys: set = {}) -> dict:
        ...
        return self._add_ratio_metric_to_dict(get_list(current_ratio_dict), current_ratio_dict)

    @abc.abstractmethod
    def get_quick_ratio(self, collection: str, keys: set = {}) -> dict:
    ...
    @abc.abstractmethod
    def get_debt_to_equity_ratio(self, collection: str, keys: set = {}) -> dict:
    ...
    @abc.abstractmethod
    def get_debt_to_assets_ratio(self, collection: str, keys: set = {}) -> dict:
    ...
    def get_equity_ratio(self, collection: str, keys: set = {}) -> dict:
        ...
        return self._add_ratio_metric_to_dict(get_list(equity_ratio_dict), equity_ratio_dict)
    ...
    def _get_growth_metric_dict(self, func) -> dict:
        ...
        growth_ratio_dict = func()
        growth_ratio_df = pd.DataFrame.from_dict(growth_ratio_dict)
        keys = get_list(keys)
        growth_ratio_df['GrowthRatio'] = (growth_ratio_df[keys[0]] - growth_ratio_df[keys[0]].shift(-1)) / growth_ratio_df[keys[0]].shift(-1) * 100
        return dict_values_to_list_values_in_dict(growth_ratio_df.to_dict()) 

    def get_revenue_growth(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
        ...
        Returns:
            dict: dict containing input keys with corresponding values for revenue.
        """
        return self._get_growth_metric_dict(self.get_revenue(collection, keys, timescale))

    def get_gross_profit_growth(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
        ...
        Returns:
            dict: dict containing input keys with corresponding values for gross profit.
        """
        return self._get_growth_metric_dict(self.get_gross_profit(collection, keys, timescale))

    def get_income_ops_growth(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
        ...
        Returns:
            dict: dict containing input keys with corresponding values for income from operations.
        """
        return self._get_growth_metric_dict(self.get_income_ops(collection, keys, timescale))

    def get_net_income_growth(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
        ...
        Returns:
            dict: dict containing input keys with corresponding values for net income.
        """
        return self._get_growth_metric_dict(self.get_net_income(collection, keys, timescale))

    def get_adj_ebitda_growth(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
        ...
        Returns:
            dict: dict containing input keys with corresponding values for adjusted EBITDA.
        """
        return self._get_growth_metric_dict(self.get_adj_ebitda(collection, keys, timescale))

    def get_fcf_growth(self, collection: str, keys: set = {}, timescale: str = 'QoQ') -> dict:
        ...
        Returns:
            dict: dict containing input keys with corresponding values for revenue.
        """
        return self._get_growth_metric_dict(self.get_fcf(collection, keys, timescale))

    # PERFORMANCE METRICS: invested capital, total assets, roa, roe, nopat roic, fcf roic  
    @abc.abstractmethod
    def get_invested_capital(self, collection: str, keys: set = {}, timescale: str = 'YoY') -> dict:
    ...
    def get_total_assets(self, collection: str, keys: set = {}, timescale: str = 'YoY') -> dict:
    ...
    def get_return_on_assets(self, collection: list = [], keys: list = [], timescale: str = 'YoY') -> dict:
        ...
        total_assets_dict = self._parse_to_timescaled_dict(collection[1], {keys[1], keys[2]}, timescale)
        if timescale == 'YoY':
        ...
        return self._add_ratio_metric_to_dict(get_list(return_on_assets_dict), return_on_assets_dict)
    ...
    def get_return_on_equity(self, collection: list = [], keys: list = [], timescale: str = 'YoY') -> dict:
        ...
        """
        net_income_dict = self._parse_to_timescaled_dict(collection[0], {keys[0], keys[2]}, timescale)
        total_stokholders_dict = self._parse_to_timescaled_dict(collection[1], {keys[1], keys[2]}, timescale)
        if timescale == 'YoY':
            net_income_dict.pop('Year')
        elif timescale == 'TTM' or 'QoQ':
            net_income_dict.pop(keys[2])
        ...
        return_on_equity_dict = net_income_dict | total_stokholders_dict
        return self._add_ratio_metric_to_dict(get_list(return_on_equity_dict), return_on_equity_dict)
    ...
    @abc.abstractmethod
    def get_nopat_roic(self, collection: str, keys: set = {}, timescale: str = 'YoY') -> dict:
    ...
    @abc.abstractmethod
    def get_wacc(self, collection, keys: set = {}, timescale: str = 'YoY') -> dict:
    ...
    def get_investor_table(self, collection: str, keys: set = {}) -> dict:
        pass
    
    def get_investor_classification(self, list_investors: set = {}) -> dict:
        pass

    def get_outstanding_shares(self, collection: str, keys: set = {}) -> dict:
    ...
    def _get_rate_fcf_roic(self, timescale: str = 'QoQ') -> dict:
        ...
        """
        fcf_roic_dict = self.get_fcf_roic(timescale) # fcf roic QoQ and date
    ...
    def _get_rate_invested_capital(self, timescale: str = 'QoQ') -> dict:
        ...
        """
        invested_capital_dict = self.get_invested_capital(timescale) # investedCapital QoQ and date
    ...
    def projected_fcf(self, timescale: str = 'QoQ') -> dict:
        ...
        fcf_dict = self._get_rate_fcf_roic(self, timescale)
        keys = get_list(fcf_dict)
        fcf_roic_rate_ttm, fcf_roic_start = average_of_dict_keys_n_values(fcf_dict, [keys[0], keys[1]], [1, 4]) 
        ...
        invested_capital_dict = self._get_rate_invested_capital(self, timescale)
        keys = get_list(fcf_dict)
        ...
        for i in range(len(array_proj_qoq)):
            fcf_i = (invested_capital_start * (1 + np.min(invested_capital_rate_ttm)^i, 0.10)) * np.min((fcf_roic_start * (1 + fcf_roic_rate_ttm)^i), 0.4)
...
class TeslaFinancials(CompanyFinancials):
    ...
    # FUNDAMENTALS
    def get_revenue(self, collection = 'statement_operations', keys: set = {'TotalRevenues', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_revenue(collection, keys, timescale)

    def get_gross_profit(self, collection = 'statement_operations', keys: set = {'GrossProfit', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_gross_profit(collection, keys, timescale)

    def get_income_ops(self, collection = 'statement_operations', keys: set = {'IncomeFromOperations', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_income_ops(collection, keys, timescale)

    def get_net_income(self, collection = 'statement_operations', keys: set = {'NetIncome', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_net_income(collection, keys, timescale)
    
    def get_adj_ebitda(self, collection = 'gaap_non_gaap', keys: set = {'AdjustedEBITDA', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_adj_ebitda(collection, keys, timescale)
    
    def get_fcf(self, collection = 'cash_flow', keys: set = {'NetCashOperatingActivities', 'Capex', 'date'}, timescale: str = 'QoQ') -> dict:
        ...
        fcf_df.drop([keys[0], keys[1]], axis = 1)
        return dict_values_to_list_values_in_dict(fcf_df.to_dict())
    
    def get_gross_profit_margin(self, collection = 'statement_operations', keys: set = {'GrossProfit', 'TotalRevenues', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_gross_profit_margin(collection, keys, timescale)
    
    def get_income_ops_margin(self, collection = 'statement_operations', keys: set = {'IncomeFromOperations', 'TotalRevenues', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_income_ops_margin(collection, keys, timescale)
    
    def get_net_income_margin(self, collection = 'statement_operations', keys: set = {'NetIncome', 'TotalRevenues', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_net_income_margin(collection, keys, timescale)
    
    def get_adj_ebitda_margin(self, collection = 'gaap_non_gaap', keys: set = {'AdjustedEBITDAMargin', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_adj_ebitda_margin(collection, keys, timescale)
        

    # LIQUIDITY & SOLVENCY
    def get_current_ratio(self, collection = 'balance_sheet', keys: set = {'TotalCurrentAssets', 'TotalCurrentLiabilities', 'date'}) -> dict:
        return super().get_current_ratio(collection, keys)
    
    def get_quick_ratio(self, collection = 'balance_sheet', keys: set = {'TotalCurrentAssets', 'Inventory', 'TotalCurrentLiabilities', 'date'}) -> dict:
    ...
    def get_debt_to_assets_ratio(self, collection = 'balance_sheet', keys: set = {}) -> dict:
        return super().get_debt_to_assets_ratio(collection, keys)
    
    # TODO: override method.
    def get_debt_to_equity_ratio(self, collection = 'balance_sheet', keys: set = {}) -> dict:
        return super().get_debt_to_equity_ratio(collection, keys)
    
    def get_equity_ratio(self, collection = 'balance_sheet', keys: set = {'TotalStockholdersEquity', 'TotalAssets', 'date'}) -> dict:
        return super().get_equity_ratio(collection, keys)
    
    
    # GROWTH METRICS
    def get_revenue_growth(self, collection = 'statement_operations', keys: set = {'TotalRevenues', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_revenue_growth(collection, keys, timescale)
    
    def get_gross_profit_growth(self, collection = 'statement_operations', keys: set = {'GrossProfit', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_gross_profit_growth(collection, keys, timescale)
    
    def get_income_ops_growth(self, collection = 'statement_operations', keys: set = {'IncomeFromOperations', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_income_ops_growth(collection, keys, timescale)
    
    def get_net_income_growth(self, collection = 'statement_operations', keys: set = {'NetIncome', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_net_income_growth(collection, keys, timescale)
    
    def get_adj_ebitda_growth(self, collection = 'gaap_non_gaap', keys: set = {'AdjustedEBITDA', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_adj_ebitda_growth(collection, keys, timescale)
    
    def get_fcf_growth(self, collection = 'cash_flow', keys: set = {'NetCashOperatingActivities', 'Capex', 'date'}, timescale: str = 'QoQ') -> dict:
        return super().get_fcf_growth(collection, keys, timescale)
    

    # PERFORMANCE METRICS
    def get_invested_capital(self, collection = 'balance_sheet', keys: set = {'TotalAssets', 'AccountsPayable', 'AccruedLiabilitiesAndOther', 'CashAndCashEquivalents', 'TotalCurrentAssets', 'TotalCurrentLiabilities', 'date'}, timescale: str = 'YoY') -> dict:
        ...
        keys = get_list(keys)
        invested_capital_df.insert(loc = 0, column= 'InvestedCapital', value= invested_capital_df[keys[0]] - invested_capital_df[keys[1]]
                                     - invested_capital_df[keys[2]] - invested_capital_df[keys[3]] - np.max(0, invested_capital_df[keys[5]] 
                                     - invested_capital_df[keys[4]] + invested_capital_df[keys[3]]))
        invested_capital_df.drop([keys[0], keys[1], keys[2], keys[3], keys[4], keys[5]], axis = 1)

        return dict_values_to_list_values_in_dict(invested_capital_df.to_dict())
    
    def get_total_assets(self, collection = 'balance_sheet', keys: set = {'TotalAssets', 'date'}, timescale: str = 'YoY') -> dict:
    ...
    def get_fcf_roic(self, timescale: str = 'YoY') -> dict:
        ...
        fcf_dict = self.get_fcf(timescale)
        invested_capital_dict = self.get_invested_capital(timescale)
        ...
        roic_dict = self._add_ratio_metric_to_dict(get_list(fcf_invested_capital_dict), fcf_invested_capital_dict)
        keys = get_list(roic_dict)
        roic_dict.pop(keys[0], keys[1])
        return roic_dict
    
    def _get_nopat(self, collection = 'statement_operations', keys: set = {'IncomeFromOperations', 'IncomeBeforeIncomeTaxes', 'ProvisionForIncomeTaxes', 'date'}, timescale: str = 'YoY') -> dict:
        ...
        nopat_df.drop([keys[0], keys[1], keys[2]])
        return dict_values_to_list_values_in_dict(nopat_df.to_dict())

    def get_nopat_roic(self, timescale: str = 'YoY') -> dict:
        nopat_dict = self._get_nopat(timescale) # NOPAT; date
        invested_capital_dict = self.get_invested_capital(timescale) # invested capital; date
        #Join into single ROIC dict.
        if timescale == 'YoY':
            nopat_dict.pop('Year')
        elif timescale == 'TTM' or 'QoQ':
        ...
        return self._add_ratio_metric_to_dict(get_list(nopat_roic_dict), nopat_roic_dict)
    ...
    # EQUITY STRUCTURE
    def get_outstanding_shares(self, collection = 'statement_operations', keys: set = {'WeightedAverageSharesDiluted', 'WeightedAverageSharesBasic', 'date'}) -> dict:
...
data = tesla.get_gross_profit_margin()
print(data)